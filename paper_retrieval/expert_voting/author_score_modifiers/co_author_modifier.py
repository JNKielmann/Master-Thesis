        ...
        for paper in doc_info.values():
            for author in paper["authors"]:
                if str(author["id"]) not in self.co_author_matrix:
                    self.co_author_matrix[author["id"]] = {}
                for co_author in doc_info["authors"]:
                    if co_author["id"] != author["id"]:
                        co_authors = self.co_author_matrix[author["id"]]
